...
export const dict = {
  ...
  pl: {
    ...
    brief: {
      ...
      back: 'wstecz',
      sending: 'Wysyłam…',
      okTitle: 'Wysłane. Dzięki, {imie}!',
      okText: 'Odpiszę na {kontakt} — zwykle w ciągu doby.',
  ...
  en: {
    ...
    brief: {
      ...
      back: 'back',
      sending: 'Sending…',
      okTitle: 'Sent. Thanks, {imie}!',
      okText: 'I will reply to {kontakt} — usually within a day.',
      errTitle: 'It did not go through.',
  ...
  it: {
    ...
    brief: {
      ...
      back: 'indietro',
      sending: 'Invio…',
      okTitle: 'Inviato. Grazie, {imie}!',
      okText: 'Ti rispondo a {kontakt} — di solito entro un giorno.',
